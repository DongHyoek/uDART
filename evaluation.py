...
## 1st -> DANN Transformer -> DA O
# (0.883, 0.5737)
## 3rd -> FT - Transformer -> DA X
# (0.8949, 0.6154)
## 5th -> DANN Transformer -> DA O , Source:MIMIC , Target:eICU
# (0.9362, 0.3658)
## 6th -> FT - Transforemr -> DA X , Source:MIMIC, Target :eICU
# (0.8913, 0.3318)

## Event Cut_off_DA(O) --> embedding dim : 32 , qkv dim = 16
"""
--- Evaluation Recall : 1.0 | Precision : 0.4996 | Accuracy : 0.7597 | 
 F1 Score : 0.4918 | AUC-ROC : 0.7112---

"""

## Event Cut_off_DA(X)
"""
--- Evaluation Recall : 1.0 | Precision : 0.5322 | Accuracy : 0.6413 | 
 F1 Score : 0.5467 | AUC-ROC : 0.6601---
"""

## Event Cut_off_3 --> low embedding dim :64, qkv dim : 32
"""
--- Evaluation Recall : 1.0 | Precision : 0.5338 | Accuracy : 0.6705 | 
 F1 Score : 0.5559 | AUC-ROC : 0.6988---
"""

## Event Cut_off_4  --> low embedding dim :128, qkv dim : 64
"""
--- Evaluation Recall : 1.0 | Precision : 0.5204 | Accuracy : 0.7474 | 
 F1 Score : 0.5294 | AUC-ROC : 0.7351---
"""

## Final DA 
"""
--- Evaluation Recall : 0.7065701380657975 | Precision : 0.31707948190848584 | Accuracy : 0.7942963764275395 | 
 F1 Score : 0.437725739233975 | AUC-ROC : 0.7560391354465532---
"""

## Final uni
"""
--- Evaluation Recall : 0.8562962488387738 | Precision : 0.18787733959333422 | Accuracy : 0.5642637780697997 | 
 F1 Score : 0.30814543274772904 | AUC-ROC : 0.6916185674363731---
"""